...
if [[ -z $SKIP_SUMS ]]; then
    ...
    do
        ...
        /recount-unify/rejoin/check_against_megadepth_resum.sh $PROJECT_SHORT_NAME $study_ $INPUT_DIR `pwd` $RECOUNT_CPUS $RECOUNT_CPUS $annotation2check > auc_resum_check.run 2>&1
    done
